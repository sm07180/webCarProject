    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'smartEditor/photo_uploader/popupfile_uploader_html5.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  :'/car/resources/file_uploader.jsp',	//샘플 URL입니다.
 	        sCallback :'/car/resources/smartEditor/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
