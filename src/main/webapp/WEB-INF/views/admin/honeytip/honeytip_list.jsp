      ...
      <h2 style="text-align: center; margin-top:10px; margin-bottom:10px;"><img style="width: 400px;" src="<c:url value='/img/admintip.png' />" /></h2>
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <a style="float:right;"class="write_btn hover" onclick="location='honeytipnew'">글쓰기</a>
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
	                <c:forEach items="${resultList }" var="model" varStatus="c">
                		<tr>
	                    <td>${model.no }</td>
	                    <td class="hover" onclick="location='honeytipdetail?tt_id=${model.tt_id}'">${model.tt_title }</td>
	                    <td>${model.tt_date }</td>
	                    <td>${model.readcnt }</td>
	                  </tr>
                	</c:forEach>
